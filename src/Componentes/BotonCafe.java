 ...
 */
public class BotonCafe extends JButton {
    ...
    // Colores base y hover ajustados a #6b1400
    private Color colorBase = Color.decode("#6B1400");  // Tono rojo oscuro / borgoña principal
    private Color colorHover = Color.decode("#871B00"); // Tono ligeramente más claro para el efecto Hover

    public BotonCafe() {
        setText("INICIAR SESIÓN");
        setFont(new Font("Segoe UI", Font.BOLD, 15));
        setForeground(Color.WHITE); // Texto en blanco para alto contraste
    ...
    protected void paintComponent(Graphics g) {
        ...
        // 1. Sombra ambiental sutil ajustada a #6b1400
        int alphaSombra = (int) (18 + (progresoHover * 32));
        g2.setColor(new Color(107, 20, 0, alphaSombra));
