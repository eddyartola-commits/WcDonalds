 ...
 */
public class BotonVerdeUsuario extends JButton {
    ...
    // Colores base y hover ajustados a #88df26
    private Color colorBase = Color.decode("#88DF26");  // Tono verde lima brillante principal
    private Color colorHover = Color.decode("#9BF236"); // Tono verde más luminoso para el efecto Hover

    public BotonVerdeUsuario() {
        setText("INICIAR SESIÓN");
        setFont(new Font("Segoe UI", Font.BOLD, 15));
        setForeground(Color.decode("#1E3B00")); // Verde muy oscuro para máximo contraste sobre fondo claro
    ...
    protected void paintComponent(Graphics g) {
        ...
        // 1. Sombra ambiental sutil acorde al verde #88df26
        int alphaSombra = (int) (18 + (progresoHover * 32));
        g2.setColor(new Color(136, 223, 38, alphaSombra));
        ...
        if (progresoHover > 0.01f) {
            g2.setColor(new Color(255, 255, 255, (int) (progresoHover * 100)));
